...
class _ControlDeckScreenState extends State<ControlDeckScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final screenBg = powerLevel > 60
        ? (widget.isDark ? Colors.green.shade900 : Colors.green.shade100)
        : powerLevel > 30
        ? (widget.isDark ? Colors.orange.shade900 : Colors.orange.shade100)
        : (widget.isDark ? Colors.red.shade900 : Colors.red.shade100);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                TactileButton(
                  ...
                  label: "CAST",
                  accentColor: const Color.fromARGB(255, 229, 5, 5),
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("FIRE"),
                ),
                TactileButton(
                  icon: Icons.shield,
                  label: "SHIELD",
                ...
                TactileButton(
                  icon: Icons.favorite,
                  label: "HEAL",
                  accentColor: const Color.fromARGB(255, 8, 227, 70),
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("HEALING"),
                ),
                TactileButton(
                  icon: Icons.blur_on,
                  label: "TELEPORT",
                  accentColor: const Color.fromARGB(255, 213, 5, 213),
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("TELEPORTATION"),
                ),
              ],
            ),
            ...
            Text(
              "Mana Capacity: ${powerLevel.toInt()}%",
